...
ROE = """** اهلا بك عزيزي المستخدم في قائمة اوامر سورس صوفي
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("اوامري") and event.query.user_id == jmbot.uid:
            buttons = [
                [Button.inline("معلومات سورس صوفي", data="AOMRDB")],
                [
...
@jmbot.tgbot.on(CallbackQuery(data=re.compile(rb"VAR")))
@check_owner
async def varssett(event):
    await event.edit(
...
ملاحظة : يمكنك استخدام الاوامر في اي دردشة او محادثة اوامر فارات سورس صوفي @SoFeThon""",
        buttons=[
            [Button.inline("رجوع", data="namevar")],
        ],
    )
...
async def varssett(event):
    await event.edit(
        """اهلا بك في قائمة اوامر سورس صوفي هذه بعض المعلومات عن السورس:

- سورس صوفي يمتلك اكثر من 100 أمر 
- هو افضل سورس عربي يتميز بالحماية



قناة السورس: @SoFeThon
حساب المطور: @x_xxi""",
        buttons=[
            [Button.inline("رجوع", data="namevar")],
        ],
...
ملاحظة : يمكنك استخدام الاوامر في اي دردشة او محادثة
اوامر فارات سورس صوفي @SoFeThon""",
        buttons=[
