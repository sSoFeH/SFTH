...
CATLOGO = "https://graph.org/file/4c9492ca51f0483ab953a.jpg"
...
async def inline_handler(event):
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("**jmbot"):
            buttons = [
                (
                    ...
                    Button.url("DEV", "https://t.me/x_xxi"),
                )
            ]
            ...
            result = builder.article(
                title="jmbot Help™",
                description="**▾∮ قائمة التعليمات الخاصة ب سورس صوفي **",
                text=_result[0],
                buttons=_result[1],
                link_preview=False,
            )
        ...
        buttons = [
            (
                Button.url("قناة السورس", "t.me/SoFeThon"),
                Button.url(
                    "المطور",
                    "t.me/RR7PP",
                ),
        ...
        result = types.InputBotInlineResult(
            id=str(uuid4()),
            type="photo",
            title="[DEV❤️‍🔥](https://t.me/x_xxi)",
            description="اذا كنت تريد تنصيبه",
            url="t.me/x_xxi",
            thumb=photo,
            content=photo,
            send_message=types.InputBotInlineMessageMediaAuto(
